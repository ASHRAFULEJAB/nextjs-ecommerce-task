      ...
      <div className="h-full w-10/12 grid grid-cols-3 justify-between">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            Dignissimos, dicta! Voluptate nihil quidem omnis voluptatibus minima
            similique error eius nostrum tempore, esse cumque alias unde autem
            molestiae officiis? Cumque, amet!
          </p>
        </div>
      </div>
    </footer>
